...
// Read in sample viddy data
// http://developer.viddy.com/docs/media
fs.readFile('./sample_json/viddy.json', 'utf8', function(err, viddy) {
  if (err) return console.log(err);

  var payload = {
    type: "viddy",
    data: JSON.parse(viddy)
  };

  // Add additional custom properties to the viddy
