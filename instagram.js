...
// Read in sample instagram data
fs.readFile('./sample_json/instagram.json', 'utf8', function(err, instagram) {
  if (err) return console.log(err);

  var payload = {
    type: "instagram",
    data: JSON.parse(instagram)
  };

  // Add additional custom properties to the instagram
